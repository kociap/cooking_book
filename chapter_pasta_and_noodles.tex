...
\header{Instructions}
All the different types of pasta follow the same dough recipe. The difference
...
See \hyperref[eggless-pasta-notes]{notes} in the \fullref{eggless-pasta} section.
